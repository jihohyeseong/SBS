    ...
    <div class="container" >
     <div class="navbar-header">     
        ...
        <div >
            ...
            <li class="nav-item"><a class="nav-link" href="<c:url value="/member/mypage?id=${pageContext.request.userPrincipal.name}"/>">My Page</a></li>
            <li class="nav-item"><a class="nav-link" href="<c:url value="/member/join"/>">Join</a></li>
            <li class="nav-item">
